...
#include "c_effects.hpp"
#include "iv_engine_effects.h"
#include "iv_render_beams.h"
#include "i_physics_surface_props.h"
#include "i_effects.h"
#include "sp_effects.h"
...
namespace interfaces {
	...
	template<typename T>
	__forceinline T get_interface2 ( const char* module_name, const char* interface_name ) {
	...
	inline c_hud_chat* chat_element;
	inline trace* trace_ray;
	inline IVEngineEffects* engine_effects;
	...
	inline c_effects* effects_system;
	inline i_view_render_beams* render_beams;
	inline physics_surface_props* surface_props_physics;
	inline void* file_system;
	inline i_effects* effects;
	inline CTeslaInfo* tesla;
	inline std::uintptr_t drawScreenEffectMaterial;
	inline ViewRender* view_render;
	inline void* spatial_partition;
	inline uint8_t* frame_render_start;
	inline IMDLCache* model_cache;
	bool initialize();
}
